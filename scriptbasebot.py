...
# Leer token desde variable de entorno o directamente en el código
TOKEN = os.environ.get("BOT_TOKEN", "8169029291:AAGO1a7CkYx0xnDGML_vq7Ug--mDdvMuSNc")
...
if __name__ == "__main__":
    # Lanza el bot en un hilo
    Thread(target=iniciar_bot).start()

    # Inicia servidor Flask para que Render detecte el puerto
