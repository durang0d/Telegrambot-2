...
async def start_webhook():
    ...
    await application.bot.set_webhook(url="https://telegrambot-2-fail.onrender.com/webhook")  # Reemplaza <your-render-app-url> con tu URL pública

    # Usando Flask para recibir el webhook
    app.add_url_rule('/webhook', view_func=application.webhook)
