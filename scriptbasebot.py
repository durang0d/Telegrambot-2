...
async def start_webhook():
    ...
    await application.bot.set_webhook(url="https://telegrambot-2-fail.onrender.com/")  # Reemplaza <your-render-app-url> con tu URL pública
    app.add_url_rule('/webhook', view_func=application.webhook_handler)
